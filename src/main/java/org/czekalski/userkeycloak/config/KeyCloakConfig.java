        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                  //  .csrf().disable()
                    ...
                    .antMatchers("/logged*","/logout*","/dashboard*","/orders/allOrders","/orders/{id}/details").authenticated()
                    .antMatchers("/dish/**","/ingredients/**","/orders/{id}/details/**","/dashboard/**","/dishesToEdit*").hasRole("admin")
